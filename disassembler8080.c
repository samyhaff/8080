...
int disassemble(char *buffer, int pc) {
    ...
    switch (*code) {
        ...
        case 0x0e: printf("MVI D, %02x", code[1]); opbytes=2; break;
        ...
        case 0x31: printf("LXI SP, %02x%02x", code[2], code[1]); opbytes=3; break; // hmmmm
        ...
        case 0xf2: printf("POP PSW"); break;
        case 0xf3: printf("JP %02x%02x", code[2], code[1]); opbytes=3; break;
        case 0xf4: printf("DI"); break;
